...
namespace backend\modules\wxservice;

use Yii;

class ModuleWxservice extends \yii\base\Module
{
	public $controllerNamespace = 'backend\modules\wxservice\controllers';
    ...
    public function beforeAction($action)
    {
        if (!parent::beforeAction($action)) return false;
            ...
            $route = 'wxplus/' . Yii::$app->controller->id . '/' . $action->id;

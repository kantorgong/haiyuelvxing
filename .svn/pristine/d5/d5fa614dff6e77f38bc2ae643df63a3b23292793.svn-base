...
<div class="wrap">
    ...
    <div id="content">
        <section class="page page1">
            <img src="<?=$site.$env?>/<?=$path?>/images/p1-img2.png" alt="潇湘晨报">
            <img src="<?=$site.$env?>/<?=$path?>/images/p1-img1.png" alt="2017新春理财季">
            <a href="start.html"><img src="<?=$site.$env?>/<?=$path?>/images/btn-start.png" alt="开始答题"></a>
        </section>
    </div>
</div>

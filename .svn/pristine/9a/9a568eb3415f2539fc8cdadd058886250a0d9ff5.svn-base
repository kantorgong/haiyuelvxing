...
var Demo = function() {
    ...
    var handleTheme = function() {
        ...
        var setColor = function(color) {
            ...
            $.ajax({
                    type: 'POST',
                    url: '/admin/user/updateskin.html',
                    //data: {User:{setting:'skin:'+skin_class}},
                    data: {User:{setting:{skin:color}}},
                    dataType:'json',
                    success: function (data) {
                        ...
                        if (!(data.status == 0))
                        {
                            ...
                            xcms_notific('操作失败', 'ruby', null, null, null);
                            //$.notific8('操作失败',{
                            //    heading: '通知',
                            //    life: 5000,
                            //    theme: 'ruby',
                        ...
                        {
                            xcms_notific('操作成功', 'lime', null, null, null);
                            //操作成功,刷新当前框架
                            //$.notific8('操作成功',{
                            //    heading: '通知',
                            //    life: 5000,
                    ...
                    error: function ()
                    {
                        //gritterAlert(errorMsg, 'gritter-error');
                        //return false;
                    }

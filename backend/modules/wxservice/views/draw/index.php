    ...
    <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
        ...
        'columns' => [
            ...
            [
                    ...
                    'filter' => \common\models\wxservice\LotteryActiveGroup::groupList(),
            ...
            [
                    ...
                    'template' => '{update}{winner}{statistics}{copy}{qrcode}',
                    'headerOptions' => ['style' => 'text-align: left; width:100px;'],
                    'header' => '操作',
                    'buttons' => [
                            ...
                            'statistics' => function ($url, $data, $model)
                            {
                                return Html::a(
                                        '数据统计',
                                        Url::toRoute(['statistics', 'id' => $data['id'], 'group_id' => $data['group_id']]),
                                        [
                                                'title' => Yii::t('yii', '数据统计'),
	                        ...
	                        'qrcode' => function($url, $data, $model)
	                        {
                                if ($data->bonus) return '';
                                return Html::a(
                                        '领奖二维码',
                                        Url::toRoute(['get-prize', 'guid' => $data['guid'], 'id' => $data['id'], 'title' => $data['act_name']]),
                                        [
                                                'title' => Yii::t('yii', '领奖二维码'),
